...
const BottomPage = () => {
    return (
        <Box marginTop={"50vh"}>
            <HStack spacing={"50px"}>
                <Card bgColor={"white"} width={"25vw"} height={"100%"} marginBottom={"10px"}>
                    <HStack>
                        <Image src={gmail} boxSize={"20px"} marginLeft={"5px"} />
                        <Text>Contact: </Text>
                        <Text color={"blue.700"}>tagrifavc@gmail.com</Text>
                    </HStack>
                </Card>
                ...
                <Card bgColor={"white"} width={"25vw"} height={"100%"} marginBottom={"10px"}>
                    <HStack>
                        ...
                        <Text>GitHub: </Text>
                        <Link color={"blue.700"} href='https://github.com/HippoBoi'>HippoBoiii</Link>
                    </HStack>
                </Card>
            </HStack>
        </Box>
